...
const App: React.FC = () => {
  ...
  const handleError = (error: any) => {
    const message = error.message || t('errorReading');
    const userFriendlyMessage = `${t('errorReading')} (${message})`;
    setReading(userFriendlyMessage);
  };
  ...
  }, [selectedSpread, language, getFullDrawnCards, t]);
